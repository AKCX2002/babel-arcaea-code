...
curl -fsSL "$BASE/prism.min.js" -o "$OUT/prism.js"
curl -fsSL "$BASE/themes/prism.min.css" -o "$OUT/prism.css"
echo "  prism.js + prism.css"

echo "=== Prism.js $VER: all plugins ==="
curl -fsSL "https://data.jsdelivr.com/v1/packages/npm/prismjs@${VER}" | python3 -c "
