(function () {
  ...
  function normalizeMermaidSvg(el) {
    ...
    /* 保留 Mermaid 原始 viewBox，只移除固定 px 宽高属性。
     * CSS (.arcaea-mermaid-box) 通过 max-height + overflow-y:auto 控制超高图滚动。
     * 不再裁剪 viewBox：Mermaid 原始 viewBox 已正确包含全部可见内容，
     * 空 edgePaths 的虚高不影响视觉渲染。 */
